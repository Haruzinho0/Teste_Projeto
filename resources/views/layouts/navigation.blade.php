<nav x-data="{ open: false }" class="bg-[#1f1f1f] border-b border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-yellow-500 hover:bg-gray-700 focus:outline-none focus:bg-gray-700 focus:text-yellow-500 transition duration-150 ease-in-out">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-[#1f1f1f]">
        ...
        <div class="pt-4 pb-1 border-t border-gray-700">
            ...
            <div class="mt-3 space-y-1">
                <x-responsive-nav-link :href="route('profile.edit')" class="text-yellow-500 hover:text-yellow-400">
                    {{ __('Profile') }}
                </x-responsive-nav-link>
